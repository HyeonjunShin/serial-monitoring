...
struct Config {
  ...
  std::vector<PacketField> packet_structure;
};

NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(SerialConfig, port, baud_rate)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(PacketFormat, header, crc_table)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(PacketField, name, type, count)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(Config, serial_config, packet_format,
                                   packet_structure)
